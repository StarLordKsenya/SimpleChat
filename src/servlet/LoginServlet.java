...
public class LoginServlet extends ChatServlet implements Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// Вывести форму
		pw.println(
				"<form action='/lab7Chat/' method='post'>Введите имя: <input type='text' name='name' value=''><input type='submit' value='Войти в чат'>");
	...
	String processLogonAttempt(String name, HttpServletRequest request, HttpServletResponse response)
		...
		if (aUser.getSessionId().equals(sessionId) || aUser
				.getLastInteractionTime() < (Calendar.getInstance().getTimeInMillis() - sessionTimeout * 1000)) {
